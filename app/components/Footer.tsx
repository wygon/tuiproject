...
export default function Footer() {
    return (
        <div className="bg-light position-relative bottom-0">
            ...
            <hr />
            <div className="ps-3 d-flex justify-content-between fs-14 pb-3">
                <span>
                ...
                <span className="d-flex gap-3 align-items-center"><PiGlobe /> Polski(PL) <span>zł PLN</span> <PiFacebookLogoFill /> <PiXLogoFill /> <PiInstagramLogoFill /></span>
            </div>
        </div>
    );
}